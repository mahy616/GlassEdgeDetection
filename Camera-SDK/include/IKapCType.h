/**
  ...
  *           All Rights Reserved
  *  @date    2017:06:19 
  *  @note    Define a subset of the types and macros that are provided by the stdint.h header on systems that comply with the C99 standard. This is meant to aid in portability.
  *  @version <1.0.0.1>
  */ 
